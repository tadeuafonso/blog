...
const AccessoryPage = () => {
  ...
  if (isError || !accessory) {
    return (
      <>
        <SEO title="Acessório não encontrado" description="Não conseguimos encontrar o acessório que você está procurando." />
  ...
  const schemaMarkup = {
    ...
    "itemReviewed": {
      ...
      "image": accessory.image || 'https://placehold.co/600x600',
      "description": accessory.summary,
    },
    "reviewRating": {
      "@type": "Rating",
      "ratingValue": accessory.rating,
      "bestRating": "10"
    },
    "author": {
      "@type": "Organization",
  ...
  return (
    <>
      <SEO 
        ...
        description={accessory.summary || `Análise completa do ${accessory.title}. Veja os prós, contras e nossa conclusão.`}
